...
namespace LuzFaltex.Zitadel.Tests
{
    /// <summary>
    ...
    public static class ResultAssert
    {
        ...
        public static void Successful<TResult>(TResult result)
        ...
        /// <summary>
        /// Asserts that the given result is unsuccessful.
        /// </summary>
        /// <param name="result">The result.</param>
        /// <typeparam name="TResult">The result type to inspect.</typeparam>
        public static void Unsuccessful<TResult>(TResult result)
            where TResult : struct, IResult
        {
